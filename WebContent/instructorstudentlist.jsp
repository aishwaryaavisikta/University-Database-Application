...
<body id="page-top" class="index">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <ul class="dropdown-menu" aria-labelledy="drop2">
                        ...
                        <li><a href="assignedcourse.jsp">ASSIGNED COURSE</a></li>
                    </ul>
                    </li>
	...
	<section id="contact">
		...
		<form name="viewbranch" id="viewbranch" method="post" action="student.jsp">
		<center>
		<div id="detail">
		<table class="table table-striped" id="tbldata" width="100%" height="100%">
		<tr id="border">
		<td align="center" valign="middle"><u><b>SL.NO</b></u></td>
		<td align="center" valign="middle"><u><b>STUDENT NAME</b></u></td>
    	...
    	try
    	{
    		...
    		String qry="select * from student where deptid="+deptid;
    	...
    	%> 	
    	<tr><td><%=count%></td>
		<td><%=rs.getString("firstname") %> <%=rs.getString("lastname") %></td><td><%=rs.getString("regdno") %></td>
		<td><a href="instructorstudentprofile.jsp?studentid=<%=rs.getInt("studentid")%>">VIEW PROFILE</a></td>
		</tr>
		<%	}
    	}
    	catch(Exception e)
