...
<body id="page-top" class="index">
    ...
    <section id="contact">
    	...
    	{int courseid=0;
    		...
    		//String qry="select * from course_alocation where deptid="+deptid;
    		PreparedStatement pstmt = con.prepareStatement("{call instructor_subject(?)}");
		...
		<td><a href="course.jsp?instructorid=<%=rs.getInt("instructorid")%>">EDIT</a></td>
		</tr><%}
    	rs.close();
        pstmt.close();
    	}
