...
<body id="page-top" class="index">
    ...
    <section id="contact">
		...
		<td align="left" valign="middle"><u><b>ASSIGNED FACULTY NAME</b></u></td>
		<td align="left"></td>
		</tr>
		<%	
    	Connection con=null;
    	...
    	{int courseid=0;
    		...
    		String qry="select distinct(coursename),instructorname,instructorid,courseid from course_alocation where deptid="+deptid;
    		...
    		while(rs.next())
    		{
    			...
    			System.out.println(instructorid+"HELLO");
    	%> 	
    	<tr><td><%=count%></td>
