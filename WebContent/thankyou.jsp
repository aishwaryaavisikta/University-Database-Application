...
<body id="page-top" class="index">
    ...
    <header>
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <!--<img class="img-responsive" src="img/138926-200.png" alt="">-->
                    <div class="intro-text">
                        <span class="name"><font size="5px"><br><%=studentname %>REGISTRATION SUCCESSFUL</font> </br><font size="10px">THANK YOU FOR REGISTRATION </font></br><font size="10px"> Please Logout!!</font></span>
                        <hr class="star-light">
