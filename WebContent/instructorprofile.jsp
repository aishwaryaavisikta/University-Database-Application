        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2">
                     <form name="sentMessage" id="contactForm" action="course.jsp">
 <%	
    				try
    				{
    					Connection con=null;
    					...
    					String qry="select * from instructor,email where instructor.eid=email.eid and instructorid="+instructorid1;
    				...
    				%> 
                  	...
                  	<%	}
    					String qry1="select distinct(coursename),courseid,instructor.instructorid from instructor,course_alocation where instructor.instructorid=course_alocation.instructorid and instructor.instructorid="+instructorid1;
    					System.out.println(qry1);
    					rs=st.executeQuery(qry1); 
    					%> 
    					<div class="row control-group">
                           <div class="form-group col-xs-12 ">
                                <label>Assigned Courses:</label><br>
                                
                        <%
    					while(rs.next())
    					{
                  	 	System.out.println(rs.getInt("instructorid")+"hello hi");%>
                  	 	<input type="hidden" name="instructorid" value="<%=rs.getInt("instructorid")%>">
                  <%=rs.getString("coursename")%><br>
                  	<%}   				}
    				catch(Exception e)
    				{
    					e.printStackTrace();
    				...
    				<div class="row control-group">
                           <div class="form-group col-xs-12 ">
                               <b><input type="submit" class="form-control" value="EDIT" ></b>
                                <p class="help-block text-danger"></p>
                            </div>
                        </div>
